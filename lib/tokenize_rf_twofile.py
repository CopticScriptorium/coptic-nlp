...
if __name__ == "__main__" or not PY3:
	from preprocess import LetterConfig, lambda_underscore
else:
	from .preprocess import LetterConfig, lambda_underscore
...
class RFTokenizer:
	...
	def read_lex(self,short_pos, lex_file):
		"""
	...
	def train(self, train_file, lexicon_file=None, freq_file=None, test_prop=0.1, output_importances=False, dump_model=False,
		...
		pos_lookup = self.read_lex(self.short_pos,lexicon_file)
