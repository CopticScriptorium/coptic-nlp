...
if __name__ == "__main__":
	...
	p.add_argument("--dev_list",default="ud_test_mini",help="file with one file name per line of conll10 training files or alias such as 'ud_dev', 'ud_mini_test")
	p.add_argument("--file_dir",default=None,help="directory with Coptic Treebank files")
	p.add_argument("--method",default="malt",choices=["malt","udpipe"],help="parser to use")
