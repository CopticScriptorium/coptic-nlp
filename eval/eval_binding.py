...
lex = script_dir + ".." + os.sep + "data" + os.sep + "copt_lemma_lex.tab"
...
def main():
	...
	p.add_argument(
		"--pos_table",
		default="copt_lemma_lex.tab",
		help="A TSV file containing POS information"
	)
	p.add_argument(
		"--group_freq_table",
		default=os.sep.join(['..', 'data', 'annis_silver_orig_group_freqs_2022_05.tab']), #TODO: change this
